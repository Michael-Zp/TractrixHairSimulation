...
void EmulationSimulatedHair::InitializeSharedBuffers(ID3D11Device * device, ID3D11DeviceContext * context)
{
...
void EmulationSimulatedHair::InitializeSplineRenderItem(ID3D11Device * device, ID3D11DeviceContext * context)
{
...
void EmulationSimulatedHair::InitializeControlPolygonRenderItem(ID3D11Device * device, ID3D11DeviceContext * context)
{
...
EmulationSimulatedHair::EmulationSimulatedHair(ID3D11Device *device, ID3D11DeviceContext *context, EmulationSimulation *simulation)
{
...
EmulationSimulatedHair::~EmulationSimulatedHair()
{
	free(mSimulation);
}

void EmulationSimulatedHair::Draw(float deltaTime, ID3D11DeviceContext *context)
{
	if (!mIsUpdated)
	{
		DebugBreak();
...
void EmulationSimulatedHair::DrawSplines(const float deltaTime, ID3D11DeviceContext * context)
{
...
void EmulationSimulatedHair::DrawControlPolygon(const float deltaTime, ID3D11DeviceContext * context)
{
	context->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_LINELIST);
...
void EmulationSimulatedHair::UpdateCamera(ID3D11DeviceContext *context, XMMATRIX view, XMMATRIX proj)
{
