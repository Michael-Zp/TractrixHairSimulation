...
void GeometryGenerator::CreateLineStrip(std::vector<XMFLOAT3> points, MeshData &meshData)
{
	meshData.Indices.resize(0);
	meshData.Vertices.resize(points.size());

	for (int i = 0; i < points.size(); i++)
	{
		meshData.Vertices[i].Position = points[i];
	}
}
