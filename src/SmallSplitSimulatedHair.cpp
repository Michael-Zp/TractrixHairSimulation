...
void SmallSplitSimulatedHair::InitializeSharedBuffers(ID3D11Device * device, ID3D11DeviceContext * context)
{
...
void SmallSplitSimulatedHair::InitializeSplineRenderItem(ID3D11Device * device, ID3D11DeviceContext * context)
{
...
void SmallSplitSimulatedHair::InitializeControlPolygonRenderItem(ID3D11Device * device, ID3D11DeviceContext * context)
{
...
SmallSplitSimulatedHair::SmallSplitSimulatedHair(ID3D11Device *device, ID3D11DeviceContext *context, SmallSplitSimulation *simulation)
{
...
SmallSplitSimulatedHair::~SmallSplitSimulatedHair()
{
	free(mSimulation);
}

void SmallSplitSimulatedHair::Draw(float deltaTime, ID3D11DeviceContext *context)
{
	if (!mIsUpdated)
	{
		DebugBreak();
...
void SmallSplitSimulatedHair::DrawSplines(const float deltaTime, ID3D11DeviceContext * context)
{
...
void SmallSplitSimulatedHair::DrawControlPolygon(const float deltaTime, ID3D11DeviceContext * context)
{
	context->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_LINELIST);
...
void SmallSplitSimulatedHair::UpdateCamera(ID3D11DeviceContext *context, XMMATRIX view, XMMATRIX proj)
{
